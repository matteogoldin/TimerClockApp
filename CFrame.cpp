...
CFrame::CFrame() : wxFrame(nullptr,wxID_ANY,"Clock",wxPoint(50,50),wxSize(285,180)){
    ...
    timeBox24h = new wxTextCtrl(this, wxID_ANY, buffer24h, wxPoint(10,10), wxSize(250,40),
                                wxTE_MULTILINE | wxTE_RICH | wxTE_READONLY, wxDefaultValidator, wxTextCtrlNameStr);
    timeBox12h = new wxTextCtrl(this, wxID_ANY, buffer12h, wxPoint(10,80), wxSize(250,40),
                                wxTE_MULTILINE | wxTE_RICH | wxTE_READONLY, wxDefaultValidator, wxTextCtrlNameStr);
    wxFont font(24,wxFONTFAMILY_TELETYPE,wxFONTSTYLE_NORMAL,wxFONTWEIGHT_BOLD,false);
    timeBox24h->SetFont(font);
    timeBox12h->SetFont(font);
    timer=new CTimer(timeBox24h,timeBox12h,buffer24h,buffer12h);
